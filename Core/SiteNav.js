...
// ==========================================
const SOCIAL_MARKS = {
  // A path split across source lines needs a separator at EVERY
  // join. Two of the joins in the GitHub mark had none, so
  // "-.62" ran into "1" as "-.621" and "-2.71" ran into "0" as
  // "-2.710"; the browser gave up part-way through and drew a
  // mangled octocat in the footer of every page on the site,
  // logging one console error per render. If you reflow these
  // strings, end each fragment with a space.
  github: {
    label: 'GitHub',
